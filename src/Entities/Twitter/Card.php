...
namespace Admingate\SeoHelper\Entities\Twitter;

use Admingate\SeoHelper\Contracts\Entities\MetaCollectionContract;
use Admingate\SeoHelper\Contracts\Entities\TwitterCardContract;
use Admingate\SeoHelper\Exceptions\InvalidTwitterCardException;
